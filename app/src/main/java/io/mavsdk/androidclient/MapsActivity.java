...
import io.mavsdk.repositories.DroneRepository;
...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    mDroneRepository = DroneRepository.getInstance(getApplication());
  }
  ...
  public void onResume() {
    ...
    mavsdkServer = mDroneRepository.getmMavsdkServer();
